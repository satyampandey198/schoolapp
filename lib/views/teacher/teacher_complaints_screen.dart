...
class TeacherComplaintsScreen extends StatefulWidget {
  const TeacherComplaintsScreen({super.key});

  @override
  State<TeacherComplaintsScreen> createState() => _TeacherComplaintsScreenState();
}
...
class _TeacherComplaintsScreenState extends State<TeacherComplaintsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final myComplaints = vm.complaints.where((c) => c.submitterId == teacherId).toList()
  ...
  void _showAddComplaintSheet(BuildContext context, TeacherViewModel vm, AuthViewModel auth) {
    String subject = '';
    String description = '';
